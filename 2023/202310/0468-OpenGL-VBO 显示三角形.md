...
定义顶点缓冲对象（VBO），并使用兼容模式（opengl_compat_profile）显示三角形。
...
pub fn main() void {
    ...
    gl.BufferData(gl.ARRAY_BUFFER, @sizeOf(f32) * 6, &vertices, gl.STATIC_DRAW);
