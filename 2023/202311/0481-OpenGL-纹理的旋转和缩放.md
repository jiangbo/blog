...
```zig
const rotate = zlm.Mat4.createAngleAxis(zlm.Vec3.new(0.0, 0.0, 1.0), zlm.toRadians(90.0));
const transform = zlm.Mat4.createUniformScale(0.5).mul(rotate);
```
