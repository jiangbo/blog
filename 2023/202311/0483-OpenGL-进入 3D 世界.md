...
const rotate = zlm.Mat4.createAngleAxis(zlm.Vec3.new(1, 0, 0), zlm.toRadians(-55.0));
const model = rotate;
...
组合了模型矩阵、视图矩阵和投影矩阵，实现了 3D 效果。

[1]: images/opengl12.png
