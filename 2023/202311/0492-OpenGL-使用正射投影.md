...
接下来将逐步开始 breakout 的实战，这个是一个 2D 游戏，所以将慢慢去掉 3D 效果。

## 顶点数据

因为 2D 只渲染一个面，所以将顶点数据从六个面减少到一个面。
...
在 2D 游戏中，视角都是在 Z 轴上，没有任何变化，所以去掉视图矩阵。
...
同时，因为投影矩阵颠倒了 y 轴的坐标，所以 setFlipVerticallyOnLoad 不在需要。
...
即将开发一个 2D 游戏，慢慢去掉之前的 3D 效果。

[1]: images/opengl18.png
