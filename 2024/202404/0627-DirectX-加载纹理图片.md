...
在之前使用顶点实现了一个旋转的正方形，现在将加载一张图片绑定到上面。
...
fn gameInit() void {
    ...
    vertices[1] = .{ .diffuse = 0xff00ff00, .u = 1 };
    vertices[2] = .{ .diffuse = 0xff0000ff, .v = 1 };
    vertices[3] = .{ .diffuse = 0xffffffff, .u = 1, .v = 1 };
