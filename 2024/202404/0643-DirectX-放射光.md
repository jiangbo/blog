...
fn gameInit() void {
    ...
    material[0].Specular.r = 0.75;
    material[0].Specular.g = 0.75;
    material[0].Specular.b = 0.75;
    material[0].Emissive.r = 0.75;
    material[0].Emissive.g = 0.75;
    material[0].Emissive.b = 0.75;
    material[0].Power = 2.0;
    ...
    hr = device.IDirect3DDevice9_SetRenderState(.SPECULARENABLE, TRUE);
    if (failed(hr)) win32Panic();
...
fn changeLight() void {
    ...
    switch (win.key.?) {
        ...
        @intFromEnum(board.VK_F1) => {
            light.Ambient.r = 0.5 - light.Ambient.r;
        },
        @intFromEnum(board.VK_F2) => {
            light.Ambient.g = 0.5 - light.Ambient.g;
        },
        @intFromEnum(board.VK_F3) => {
            light.Ambient.b = 0.5 - light.Ambient.b;
        },
        '1' => {
            light.Attenuation0 = 1.0;
            light.Attenuation1 = 0.0;
