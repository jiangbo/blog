...
var vertices: [3]CustomVertex = undefined;
var angle: f32 = 0;
...
fn gameUpdate() void {
    ...
    const hr = device.IDirect3DDevice9_DrawPrimitiveUP(.TRIANGLELIST, //
        1, &vertices, @sizeOf(CustomVertex));
    if (failed(hr)) win32Panic();
