...
fn gameUpdate() void {
    ...
    // vertex 3
    vertices[3].x = width / 2 + @cos(angle) * RADIUS;
    vertices[3].y = height / 2 + @sin(angle) * RADIUS;
    ...
    const hr = device.IDirect3DDevice9_DrawPrimitiveUP(.LINESTRIP, //
