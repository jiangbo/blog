...
pub fn init(app: *App) !void {
    ...
    const zToWMatrix = mach.math.Mat4x4.init(
        &mach.math.Mat4x4.RowVec.init(1, 0, 0, 0),
        &mach.math.Mat4x4.RowVec.init(0, 1, 0, 0),
        &mach.math.Mat4x4.RowVec.init(0, 0, 1, 0),
        &mach.math.Mat4x4.RowVec.init(0, 0, 10, 1),
    );
    ...
    app.projection = zToWMatrix.mul(&app.projection);
